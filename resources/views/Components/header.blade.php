    ...
    <div class="headerDivision">
        ...
        @if (Auth::check())
            ...
            <nav class="dropdown">
                ...
                @if (Auth::user()->profile->photo_path == null)

                <div data-bs-toggle="dropdown" aria-expanded="false">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="{{Auth::user()->profile->color}}" class="bi bi-hypnotize profile-photo without-profile-photo-animation" viewBox="0 0 16 16">
                ...
                @else
                    ...
                    <div class="d-block text-decoration-none link-dark" data-bs-toggle="dropdown" aria-expanded="false">
                        <img src="{{Auth::user()->profile->photo_path}}" alt="{{Auth::user()->profile->name}}" class="profile-photo rounded-circle">
                    </div>
